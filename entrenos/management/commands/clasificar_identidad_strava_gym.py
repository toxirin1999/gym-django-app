...
class Command(BaseCommand):
    help = "Clasifica en JSONL la identidad Strava/Gym/hub. Siempre es de solo lectura."
    ...
    def handle(self, *args, **options):
        ...
        result = clasificar_identidad_strava_gym(
            cliente_id=options["cliente"], desde=desde, hasta=hasta, limit=options["limit"],
        )
        for record in [*result["classifications"], result["summary"]]:
