    ...
    def test_sesion_ignora_volumen_del_front_y_usa_suma_exacta_backend(self):
        ...
        response = self.client.post(
            reverse('entrenos:guardar_entrenamiento_activo', args=[self.cliente.pk]),
            {
                ...
                'ej1_nombre': self.NOMBRE,
                'ej1_tipo_progresion': 'peso_reps',
                'ej1_peso_1': '60', 'ej1_reps_1': '4', 'ej1_rpe_1': '8', 'ej1_completado_1': '1',
                'ej1_peso_2': '65', 'ej1_reps_2': '4', 'ej1_rpe_2': '8', 'ej1_completado_2': '1',
                'ej1_peso_3': '65', 'ej1_reps_3': '3', 'ej1_rpe_3': '8', 'ej1_completado_3': '1',
                'ej1_peso_4': '65', 'ej1_reps_4': '3', 'ej1_rpe_4': '8', 'ej1_completado_4': '1',
