    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupo_muscular', models.CharField(
                    choices=[('Pecho', 'Pecho'), ('Espalda', 'Espalda'), ('Piernas', 'Piernas'), ('Hombros', 'Hombros'),
                             ('Bíceps', 'Bíceps'), ('Tríceps', 'Tríceps'), ('Glúteos', 'Glúteos'), ('Core', 'Core'),
                             ('Cardio', 'Cardio'), ('Otros', 'Otros')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuente_datos',
                 models.CharField(choices=[('manual', 'Manual'), ('liftin', 'Liftin')], default='manual',
                                  max_length=20)),
                ...
                ('numero_ejercicios',
                 models.PositiveIntegerField(blank=True, help_text='Número total de ejercicios realizados', null=True)),
                ('tiempo_total_formateado',
                 models.CharField(blank=True, help_text='Duración total en texto (ej: 1:10:23)', max_length=20,
                                  null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entreno',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ejercicios_realizados',
                                   to='entrenos.entrenorealizado')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre_ejercicio',
                 models.CharField(help_text='Nombre del ejercicio como aparece en Liftin', max_length=200)),
                ('orden_ejercicio',
                 models.PositiveIntegerField(default=1, help_text='Orden del ejercicio en la rutina')),
                ('peso_kg',
                 models.DecimalField(blank=True, decimal_places=2, help_text='Peso utilizado en kg', max_digits=8,
                                     null=True)),
                ('peso_formateado',
                 models.CharField(blank=True, help_text='Peso como aparece en Liftin (ej: 268.5 kg, PC, 90-100 kg)',
                                  max_length=50, null=True)),
                ('series_realizadas', models.PositiveIntegerField(default=1, help_text='Número de series realizadas')),
                ('repeticiones_formateado',
                 models.CharField(blank=True, help_text='Repeticiones como aparecen en Liftin (ej: 3x5-10, 3x10-12)',
                                  max_length=50, null=True)),
                ('repeticiones_min',
                 models.PositiveIntegerField(blank=True, help_text='Repeticiones mínimas por serie', null=True)),
                ('repeticiones_max',
                 models.PositiveIntegerField(blank=True, help_text='Repeticiones máximas por serie', null=True)),
                ('completado',
                 models.BooleanField(default=True, help_text='Si el ejercicio fue completado exitosamente')),
                ('estado_liftin', models.CharField(
                    choices=[('completado', '✓ Completado'), ('fallado', '✗ Fallado'), ('nuevo', 'N Nuevo'),
                             ('parcial', '~ Parcial')], default='completado',
                    help_text='Estado del ejercicio según Liftin', max_length=20)),
                ('notas_ejercicio',
                 models.TextField(blank=True, help_text='Notas específicas de este ejercicio', null=True)),
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('entreno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre',
                 models.CharField(help_text='Nombre del ejercicio (ej: Prensa, Curl Femoral Tumbado)', max_length=200)),
                ...
                ('estado', models.CharField(
                    choices=[('completado', '✓ Completado'), ('fallado', '✗ Fallado'), ('nuevo', 'N Nuevo'),
                             ('parcial', '~ Parcial')], default='completado', max_length=20)),
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('entreno',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ejercicios_liftin',
                                   to='entrenos.entrenorealizado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('completado', models.BooleanField(default=True)),
                ('ejercicio',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rutinas.ejerciciobase')),
                ('entreno',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='detalles_ejercicio',
                                   to='entrenos.entrenorealizado')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datos_frecuencia_cardiaca',
                 models.JSONField(blank=True, help_text='Array de datos de frecuencia cardíaca con timestamps',
                                  null=True)),
                ...
                ('metadatos_adicionales',
                 models.JSONField(blank=True, help_text='Otros datos específicos de Liftin en formato JSON',
                                  null=True)),
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('fecha_actualizacion', models.DateTimeField(auto_now=True)),
                ('entreno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='datos_liftin',
                                              to='entrenos.entrenorealizado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ejercicio',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rutinas.ejerciciobase')),
                ('entreno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='series',
                                              to='entrenos.entrenorealizado')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ejercicio',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rutinas.ejerciciobase')),
                ('rutina', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                             to='rutinas.rutina')),
            ],
            options={
