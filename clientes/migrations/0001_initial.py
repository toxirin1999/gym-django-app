    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('humor', models.CharField(blank=True,
                                           choices=[('verde', '😊 Bien'), ('amarillo', '😐 Neutro'), ('rojo', '😞 Bajo')],
                ...
                ('energia_subjetiva',
                 models.PositiveSmallIntegerField(blank=True, help_text='Energía subjetiva de 0 a 10', null=True)),
                ('dolor_articular',
                 models.PositiveSmallIntegerField(blank=True, help_text='Dolor articular de 0 a 10', null=True)),
                ('autoconciencia', models.TextField(blank=True, help_text='¿Qué emoción domina (0-10)?', null=True)),
                ('descarga_cognitiva',
                 models.TextField(blank=True, help_text='Escribe 5’ “lo que me preocupa AHORA”', null=True)),
                ('rumiacion_baja',
                 models.BooleanField(blank=True, help_text='¿La rumiación bajó después de escribir?', null=True)),
                ...
                ('cosas_positivas',
                 models.TextField(blank=True, help_text='Escribe 3 cosas que funcionaron hoy.', null=True)),
                ('aprendizaje', models.TextField(blank=True, null=True)),
                ('quien_quiero_ser',
                 models.TextField(blank=True, help_text='Describe qué tipo de persona quieres ser hoy.', null=True)),
                ('tareas_dia', models.TextField(blank=True,
                                                ...
                                                null=True)),
                ('que_puedo_mejorar',
                 models.TextField(blank=True, help_text='Reflexiona sobre qué podrías mejorar del día.', null=True)),
                ('reflexion_diaria',
                 models.TextField(blank=True, help_text='Escribe una reflexión libre sobre tu día.', null=True)),
                ('limito_socialmente', models.BooleanField(help_text='¿Respondiste solo, sin iniciar?', null=True)),
                ('check_in_energia', models.CharField(blank=True, choices=[('si', 'Sí, doy más de lo que recibo'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('humor_dominante',
                 models.CharField(choices=[('verde', '😊 Bien'), ('amarillo', '😐 Neutro'), ('rojo', '😞 Bajo')],
                                  max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medida', models.CharField(
                    choices=[('peso', 'Peso (kg)'), ('grasa', 'Grasa corporal (%)'), ('cintura', 'Cintura (cm)')],
                    max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(
                    choices=[('subir', 'Subir carga'), ('bajar', 'Bajar carga'), ('mantener', 'Mantener carga')],
                    max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.ImageField(blank=True, default='clientes_fotos/default.png', null=True,
                                           upload_to='clientes_fotos/')),
                ('experiencia_años',
                 models.FloatField(default=0, help_text='Años de experiencia entrenando de forma consistente.',
                                   validators=[django.core.validators.MinValueValidator(0)],
                                   verbose_name='Años de experiencia')),
                ('objetivo_principal', models.CharField(
                    choices=[('hipertrofia', 'Hipertrofia Muscular'), ('fuerza', 'Ganancia de Fuerza'),
                             ('perdida_peso', 'Pérdida de Peso'), ('resistencia', 'Mejora de Resistencia'),
                             ('general', 'Salud General')], default='general',
                    help_text='El objetivo principal del cliente para personalizar su experiencia.', max_length=50)),
                ('dias_disponibles',
                 models.IntegerField(default=4, help_text='Días reales por semana que puede entrenar (2-7)',
                                     validators=[django.core.validators.MinValueValidator(2),
                                                 django.core.validators.MaxValueValidator(7)],
                                     verbose_name='Días disponibles por semana')),
                ('tiempo_por_sesion',
                 models.IntegerField(default=90, help_text='Minutos reales disponibles por sesión (30-180)',
                ...
                ('ejercicios_preferidos',
                 models.JSONField(default=list, help_text='Ejercicios que disfruta hacer - mejora adherencia',
                                  verbose_name='Ejercicios preferidos')),
                ('ejercicios_evitar', models.JSONField(default=list,
                                                       help_text='Ejercicios que no puede/quiere hacer - lesiones, limitaciones',
                                                       verbose_name='Ejercicios a evitar')),
                ('flexibilidad_horario',
                 models.BooleanField(default=True, help_text='¿Puede cambiar horarios si surge un imprevisto?',
                                     verbose_name='Flexibilidad de horario')),
                ('nivel_estres',
                 models.IntegerField(default=5, help_text='Nivel de estrés actual (1=muy bajo, 10=muy alto)',
                                     validators=[django.core.validators.MinValueValidator(1),
                                                 django.core.validators.MaxValueValidator(10)],
                                     verbose_name='Nivel de estrés')),
                ('calidad_sueño',
                 models.IntegerField(default=7, help_text='Calidad del sueño (1=muy mala, 10=excelente)',
                                     validators=[django.core.validators.MinValueValidator(1),
                                                 django.core.validators.MaxValueValidator(10)],
                                     verbose_name='Calidad del sueño')),
                ('nivel_energia',
                 models.IntegerField(default=7, help_text='Nivel de energía general (1=muy bajo, 10=muy alto)',
                                     validators=[django.core.validators.MinValueValidator(1),
                                                 django.core.validators.MaxValueValidator(10)],
                                     verbose_name='Nivel de energía')),
                ('one_rm_data', models.JSONField(default=dict,
                                                 help_text="1RM por ejercicio: {'sentadilla': 100, 'press_banca': 80, 'peso_muerto': 120}",
                                                 verbose_name='Datos de 1RM')),
                ('historial_volumen', models.JSONField(default=dict,
                ...
                ('perfil_nutricion',
                 models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                      related_name='cliente_asociado', to='nutricion_app_django.userprofile',
