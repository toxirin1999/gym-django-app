"""
Tests for Phase JOI Habitación 2A — Estado de presencia reactivo.

Verifica que determinar_estado_habitacion_joi() retorna estado correcto
según señales reales: SILENCIO, PRESENTE, PROTEGIENDO.

8 tests básicos de prioridad y lógica de decisión.
"""
...
class JoiHabitacion2AEstadoTests(TestCase):
    """Tests para determinar_estado_habitacion_joi()"""
    ...
    def test_pulso_protegiendo_devuelve_protegiendo(self):
        ...
        # Mock: crear condición que force PROTEGIENDO
