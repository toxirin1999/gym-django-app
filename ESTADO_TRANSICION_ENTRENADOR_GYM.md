...
|---|---|---|---|
| **0. Visión e inventario** | **En observación** | Producto definido en [PRODUCTO_ENTRENADOR_GYM.md](PRODUCTO_ENTRENADOR_GYM.md); inventario pasivo en [`auditar_superficies_archivo.py`](entrenos/management/commands/auditar_superficies_archivo.py). | Consolidar y mantener un inventario vivo, único y exhaustivo de todos los módulos, rutas y procesos; actualizar su clasificación cuando cambie una superficie. |
